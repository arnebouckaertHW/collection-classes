...
class stack:
    ...
    def pop(self):
        ...
        Returns:
            _type_: element at head (top) of the calling stack
        """
        ...
        try:
            ...
            # remove the node at the head (top) of the calling stack
    ...
    def peek(self):
        """Returns the element at the head (top) of the calling stack.
